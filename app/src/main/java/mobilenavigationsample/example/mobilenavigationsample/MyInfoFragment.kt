...
class MyInfoFragment : Fragment() {
    ...
    override fun onCreateView(
        ...
        val originalBackground = ContextCompat.getDrawable(requireContext(),
            R.drawable.edittext_border
        )
        val focusedBackground = ContextCompat.getDrawable(requireContext(),
            R.drawable.click_edittext_border
        )
