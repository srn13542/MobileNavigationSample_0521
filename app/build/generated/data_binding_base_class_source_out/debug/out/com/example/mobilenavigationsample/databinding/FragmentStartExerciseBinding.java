...
public final class FragmentStartExerciseBinding implements ViewBinding {
  ...
  @NonNull
  public final Button startExerciseButton;

  private FragmentStartExerciseBinding(@NonNull FrameLayout rootView,
      @NonNull Button startExerciseButton) {
  ...
  public static FragmentStartExerciseBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      Button startExerciseButton = ViewBindings.findChildViewById(rootView, id);
      if (startExerciseButton == null) {
        break missingId;
      }

      return new FragmentStartExerciseBinding((FrameLayout) rootView, startExerciseButton);
    }
